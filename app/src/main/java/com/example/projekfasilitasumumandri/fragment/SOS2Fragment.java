...
public class SOS2Fragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        return inflater.inflate(R.layout.fragment_sos_2, container, false);
    }
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        try {
            ...
            lokasiSOS = sosDAO.getSOSKategori("kepolisian");
    ...
    private void recyclerAdapter(View view) {
        try {
            RecyclerView recyclerView = view.findViewById(R.id.recycler_sos2);
