...
public class SOS3Fragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        return inflater.inflate(R.layout.fragment_sos_3, container, false);
    }
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        try {
            ...
            lokasiSOS = sosDAO.getSOSKategori("rs");
    ...
    private void recyclerAdapter(View view) {
        try {
            RecyclerView recyclerView = view.findViewById(R.id.recycler_sos3);
